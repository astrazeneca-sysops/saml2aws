...
func main() {
	...
	app.Flag("mfa-token", "The current MFA token (supported in Keycloak, ADFS, Ping). (env: SAML2AWS_MFA_TOKEN)").Envar("SAML2AWS_MFA_TOKEN").StringVar(&commonFlags.MFAToken)
